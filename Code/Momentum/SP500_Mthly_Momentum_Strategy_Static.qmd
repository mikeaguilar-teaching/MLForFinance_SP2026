...
We are adding up how big all of our bets are, regardless of whether they are long or short.

Let's say we have $\$48$ in long positions and $\$47$ in short positions. Then gross exposure if $\$97$.

Q: Why doesn't gross exposure change throughout the sample?

A: We chose our position sizes at the beginning of the period. The portfolio value and pnL might vary, but the exposure remains constant until we rebalance.

Q: Why isn't gross exposure = 100?

A:

Because we used raw weights. The sum of the absolute values of the raw weights is not equal to 1. We can scale the weights so that they sum to 1.

# Fully Invested Weights

Task: Create a weight dataframe. Set the
