...
```{r}
Train  <- SP500_Mthly_Momentum %>% filter(Date <= as.Date("2025-09-30"))
...
SP500_Mthly_Prices <- read_csv(here("Data","SP500_Mthly_Prices.csv"))
